...
<tileset version="1.8" tiledversion="1.8.6" name="clydebn6_securitycube" tilewidth="48" tileheight="52" tilecount="14" columns="7" objectalignment="bottom">
 <tileoffset x="0" y="12"/>
 <grid orientation="orthogonal" width="64" height="32"/>
 <image source="clydebn6_securitycube.png" width="336" height="104"/>
 <tile id="0">
  <objectgroup draworder="index" id="5">
   <object id="6" x="24" y="13">
