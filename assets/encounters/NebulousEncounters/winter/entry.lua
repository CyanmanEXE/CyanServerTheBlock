...
local box_id = "com.louise.enemy.WindBox" --V1/V2/V3/SP/NM
local fishy_id = "com.louise.enemy.Fishy" --V1,V2,V3,SP, NM
local rak_id = "com.louise.enemy.Cragger" --V1,V2,V3,R1,R2,SP,NM
local scuttlest_id = "com.louise.enemy.Scuttlest"-- v1, NM
local pirana_id = "com.louise.enemy.Piranha" --v1
local volcano_id = "com.louise.enemy.Volcano" --V1,V2,V3,R1,R2,SP,NM
...
local ratty_id = "com.Dawn.BN3.Enemy.Ratty" --V1,V2,V3,SP
local lark_id = "com.louise.enemy.Lark"--V1
local bark_id = "com.louise.enemy.Bark"--V1,R1,R2,SP,NM
local scutz_id = "com.louise.enemy.Scutz" --V1
local scuttler_id = "com.louise.enemy.Scuttler"--V1
local scuttzer_id = "com.louise.enemy.Scuttzer"--v1
local scuttle_id ="com.louise.enemy.Scuttle"--v1
local flashy_id = "com.louise.enemy.Flashy"--V1,V2,V3,R1,R2,SP,NM
local candal_id = "com.louise.enemy.HauntedCandle" --V1,V2,V3,SP,R1,R2
...
function package_requires_scripts()
    ...
    Engine.requires_character(ratty_id)
    Engine.requires_character(lark_id)
    Engine.requires_character(bark_id)
    Engine.requires_character(scutz_id)
    Engine.requires_character(scuttler_id)
    Engine.requires_character(scuttzer_id)
    Engine.requires_character(scuttle_id)
    Engine.requires_character(flashy_id)
    Engine.requires_character(candal_id)
end
...
function package_build(mob, data)
    print("Loading winter Liberation Encounter")
    ...
    if data.terrain == "advantage" then
        ...
        elseif choice == 2 then
            mob:create_spawner(skell_id, Rank.V1):spawn_at(6, 1)--!
            mob:create_spawner(skell_id, Rank.V1):spawn_at(6, 3)
            mob:create_spawner(swordy_id, Rank.V3):spawn_at(5, 2)
        elseif choice == 3 then
            mob:create_spawner(cirkill_id, Rank.V1):spawn_at(5, 1)--!
            mob:create_spawner(rak_id, Rank.V2):spawn_at(6, 2)
            mob:create_spawner(cirkill_id, Rank.V1):spawn_at(5, 3)
        elseif choice == 4 then
            mob:create_spawner(bunny_id, Rank.V1):spawn_at(6, 1)--!
            
            mob:create_spawner(bunny_id, Rank.V1):spawn_at(6, 3)
        elseif choice == 5 then
            
            mob:create_spawner(scuttlest_id, Rank.NM):spawn_at(6, 2)--!
            
        elseif choice == 6 then
            mob:create_spawner(burner_id, Rank.V1):spawn_at(5, 1)--!
            mob:create_spawner(burner_id, Rank.SP):spawn_at(6, 3)
           
        elseif choice == 7 then
            mob:create_spawner(boomer_id, Rank.V1):spawn_at(6, 1)--!
            
            mob:create_spawner(chumpy_id, Rank.V1):spawn_at(5, 2)
        elseif choice == 8 then
            mob:create_spawner(joker_id, Rank.V1):spawn_at(6, 1)--!
            mob:create_spawner(swordy_id, Rank.SP):spawn_at(5, 2)
    ...
    elseif data.terrain == "disadvantage" then
        ...
        local choice = math.random(8)
        if choice == 1 then
            mob:create_spawner(pirana_id, Rank.V2):spawn_at(6, 1)--!
        ...
        elseif choice == 2 then
            ...
            mob:create_spawner(ratty_id, Rank.V3):spawn_at(3, 3)
            mob:create_spawner(chumpy_id, Rank.V1):spawn_at(5, 2)
        elseif choice == 3 then
        ...
        elseif choice == 4 then
            ...
            mob:create_spawner(rak_id, Rank.NM):spawn_at(4, 2)--!
        elseif choice == 5 then
            mob:create_spawner(box_id, Rank.NM):spawn_at(4, 1)--!
        ...
        elseif choice == 7 then
            mob:create_spawner(bladia_id, Rank.V1):spawn_at(6, 2)--!
        
        elseif choice == 8 then
            mob:create_spawner(rak_id, Rank.V1):spawn_at(5, 1)--!
            mob:create_spawner(rak_id, Rank.V1):spawn_at(4, 2)
            mob:create_spawner(shrimp_id, Rank.V1):spawn_at(3, 3)
        end
    elseif data.terrain == "surrounded" then
        ...
        local choice = math.random(8)
        if choice == 1 then
            mob:create_spawner(metrid_id, Rank.V2):spawn_at(1, 1)--!
            mob:create_spawner(shrimp_id, Rank.V3):spawn_at(5, 2)
            mob:create_spawner(fishy_id, Rank.V3):spawn_at(6, 3)
        elseif choice == 2 then
            mob:create_spawner(candal_id, Rank.V3):spawn_at(6, 1)--!
            
            mob:create_spawner(candal_id, Rank.V3):spawn_at(1, 3)
        elseif choice == 3 then
            
            mob:create_spawner(powie3_id, Rank.V1):spawn_at(6, 3)--!
            mob:create_spawner(tark_id, Rank.V1):spawn_at(1, 2)
        elseif choice == 4 then
            mob:create_spawner(pirana_id, Rank.V3):spawn_at(1, 3)--!
            mob:create_spawner(chumpy_id, Rank.V1):spawn_at(6, 2)
            mob:create_spawner(scuttler_id, Rank.V1):spawn_at(2, 3)
        elseif choice == 5 then
        ...
        elseif choice == 6 then
            mob:create_spawner(cacter_id, Rank.V1):spawn_at(6, 1)--!
            mob:create_spawner(volcano_id, Rank.V2):spawn_at(2, 2)
            mob:create_spawner(cacter_id, Rank.V1):spawn_at(1, 3)
        elseif choice == 7 then
            mob:create_spawner(volcano_id, Rank.V2):spawn_at(1, 1)--!
            mob:create_spawner(rak_id, Rank.V2):spawn_at(6, 2)
            
        elseif choice == 8 then
            mob:create_spawner(canguard_id, Rank.SP):spawn_at(1, 1)--!
            mob:create_spawner(canguard_id, Rank.V3):spawn_at(1, 2)
            mob:create_spawner(canguard_id, Rank.SP):spawn_at(1, 3)
        end
    else
        mob:enable_freedom_mission(3, false)
        ...
        if choice == 1 then
            mob:create_spawner(ratty_id, Rank.V3):spawn_at(4, 1)
            mob:create_spawner(cirkill_id, Rank.V2):spawn_at(5, 1)
            mob:create_spawner(ratty_id, Rank.V1):spawn_at(6, 1)
        elseif choice == 2 then
            mob:create_spawner(bladia_id, Rank.V1):spawn_at(6, 1)
        ...
        elseif choice == 5 then
            ...
            mob:create_spawner(sniper_id, Rank.V1):spawn_at(4, 3)
